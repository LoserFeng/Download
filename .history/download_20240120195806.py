...
src_url="https://s3-eu-west-1.amazonaws.com/pstorage-plus-7003492043/36682266/noise_ceilings.zip?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIA3OGA3B5WLN3GODUZ/20240120/eu-west-1/s3/aws4_request&X-Amz-Date=20240120T115053Z&X-Amz-Expires=10&X-Amz-SignedHeaders=host&X-Amz-Signature=999399392c17d577a29466597caad01059be22c2ec704f144abe1d6b75812aec"
...
class Downloader():
    ...
    chunk_size:int = 1024 * 1024 * 1024  # 1G
    ...
    def download_by_stream(self):
        ...
        response = requests.post(self.src_url, headers=headers,stream=True, data=self.form_data)
